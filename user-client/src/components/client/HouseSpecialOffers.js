...
class HouseSpecialOffers extends React.Component{
   ...
   async componentDidMount(){
    ...
    makeReservation(s){
        ...
        this.state.reservation.numberOfPeople = this.state.house.numberOfBeds
            ...
            return(
                ...
                <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                    <div class="media-body order-2 order-lg-1">
                        ...
                        <h6 class="font-italic my-2">Number of people: {this.state.house.numberOfBeds}</h6>
                        <p class="font-italic text-muted mb-0 small">Regular price: {this.state.house.price}$</p>
...
export default withNavigation(withParams(HouseSpecialOffers));