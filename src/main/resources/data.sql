...
INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
              VALUES (1,'Nikola','Kojic', 'Loncarska 8', 'Novi Sad', '063563965','nikola@gmail.com',
                      '$2a$10$oD0Cq/HgF.l/u5yUH3KdUuSl77Npw16xZuGHYbp10u9kO2onfEzC.','ADMIN', true, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (2,'Anja','Pesic', 'Dunavska 8', 'Novi Sad', '064953666','anja@gmail.com',
        '$2a$10$Sk1tQ9a7gW6hPbNEG.M5Bu8O7GQ3.rTOq9M6f4Ffrw.EY5kErwV0W','HOUSE_OWNER', true, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (3,'Boris','Horvat', 'Narodnog fronta 58', 'Novi Sad', '064789632','boki@gmail.com',
        '$2a$10$boa9C8KlOVUp0qmNP.TF4OtgNBD8N5hcZZ8VGikhynrT1rMJbQH8C','BOAT_OWNER', true, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (5,'Klient','Horvat', 'Narodnog fronta 58', 'Novi Sad', '064789632','klient@gmail.com',
        '$2a$10$oD0Cq/HgF.l/u5yUH3KdUuSl77Npw16xZuGHYbp10u9kO2onfEzC.','CLIENT', true, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (4,'test','Kojic', 'Loncarska 8', 'Novi Sad', '063563965','test@gmail.com',
        '$2a$10$oD0Cq/HgF.l/u5yUH3KdUuSl77Npw16xZuGHYbp10u9kO2onfEzC.','HOUSE_OWNER', false, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (6,'Instructor','Horvat', 'Narodnog fronta 58', 'Novi Sad', '064789632','instructor@gmail.com',
        '$2a$10$oD0Cq/HgF.l/u5yUH3KdUuSl77Npw16xZuGHYbp10u9kO2onfEzC.','INSTRUCTOR', true, false, 0);

INSERT INTO users (id, first_name, surname, address, city, phone_number, email, password, type, is_approved, is_deleted, version)
VALUES (7,'Nenad','Jeckovic', 'Gagarinova 18', 'Novi Sad', '0669130009','nenad.jeckovic@gmail.com',
        '$2a$10$23KQMimOCWbHIosrB7vxNOe2tNdTcOcjFD1txjdkgsOqJeXlTHowu','CLIENT', true, false, 0);
...
INSERT INTO clients (id, penalty_num) values(7,0);
insert into instructors (id) values(6);

INSERT INTO renting_entity (id, name, address, description, price, renting_rules, renting_entity_type, latitude, longitude, version)
VALUES (1, 'Vila Grand', 'Stevana Milovanova 3', 'bla', 100, 'bla', 'HOUSE', 45.258779, 19.8509698, 0);

INSERT INTO house (id, number_of_beds, number_of_rooms, house_owner_id) VALUES (1, 2, 1, 2);

INSERT INTO renting_entity (id, name, address, description, price, renting_rules, renting_entity_type, latitude, longitude, version)
VALUES (2, 'Vila Ana', 'Dunavska 3', 'bla', 150, 'bla', 'HOUSE', 45.2568201, 19.8486402, 0);
...
INSERT INTO renting_entity (id, name, address, description, price, renting_rules, renting_entity_type, latitude, longitude, version)
VALUES (3, 'D&D', 'Suncani kej 3', 'bla', 300, 'bla', 'BOAT', 45.234150, 19.834890, 0);
...
INSERT INTO renting_entity (id, name, address, description, price, renting_rules, renting_entity_type,latitude, longitude, version)
VALUES (4, 'Lila', 'Ribarsko ostrvo 10', 'bla', 200, 'bla', 'BOAT', 45.232360, 19.836110, 0);
...
INSERT INTO renting_entity (id, name, address, description, price, renting_rules, renting_entity_type,latitude, longitude, version)
VALUES (5, 'Sarani', 'Ribarsko ostrvo 10', 'bla', 200, 'bla', 'ADVENTURE', 45.232360, 19.836110, 0);
...
insert into available_periods(id, end, is_special_offer, special_price, start, renting_entity_id)
values(3, '2022-09-18', true, 50, '2022-09-19', 1);
...
values(1, false,'2022-06-01', 3, 3, 300, '2022-05-30' , 5,2, 1);
